...
/*   Updated: 2024/07/22 14:57:19 by zibnoukh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	execute(t_box *box)
{
	...
	if (box->done_heardoc)
	{
		...
		while (box->node->command)
		{
			t_redirection *tmp_red = box->node->command->redirection;
			// f__redirection(box, tmp_red);
	    	heardoc___s(tmp_red);
			// while (tmp_red)
			// {
			// 	// if (redirection->flag == 2)
			...
			// 	// 	box->append = 100;
			// 	// }
			// 	printf("tmp_red->str: %s\n", tmp_red->str);
			// 	printf("tmp_red->flag: %d\n", tmp_red->flag);
